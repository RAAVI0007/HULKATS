	...
	private static Logger logger = Logger.getLogger(EditDetailsController.class);
	 ...
	 private static Properties prop = null;
	   ...
	   return users; 
	    ...
	    public  @ResponseBody JobsDocuments getAllDocuments(@RequestParam("jobid") int jobid,@RequestParam("applicantid") int applicantid) {
	   ...
	   return jobdocuments; 
	    ...
	    public  @ResponseBody List<User> getRecruitersUnderManager(HttpSession session,@RequestParam("rolename") String rolename) {
	   ...
	   return users; 
	    ...
	    public  @ResponseBody List<User> getRecruitersNotAssign(@RequestParam("rolename") String rolename,HttpSession session) {
	       logger.info("rolename:"+rolename);
	       String organization =(String)session.getAttribute("organization");
	       int roleid=0;
	       List<User> users=null;
	   ...
	   return users; 
	    ...
	    public @ResponseBody String changeJobStatus(HttpSession session,@RequestParam("jobid") int jobid,@RequestParam("status") String jobstatus){
		...
		public @ResponseBody String jobcreation(HttpSession session,@RequestParam("jobcreation") String jobStr, Model map, HttpServletRequest req) {
			...
			String document2=null;
			 String videoname = null;
				...
				try {
					//java.util.Date todayDate = new java.util.Date();
					   ...
					   if (createjob.getFiletype3() != null) {
							...
							//File destinationVideo = new File(this.context.getRealPath("/WEB-INF/videos") + File.separator + videoname);
				...
				if(createjob.getFiletype1().equals("vnd.openxmlformats-officedocument.wordprocessingml.document")){
			      document1=createjob.getDocname1()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+"."+"docx";
			      
				}else{
					
				 document1=createjob.getDocname1()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+"."+"pdf";
				}
				
			  //  File destinationFile1 = new File(context.getRealPath("/WEB-INF/uploaded")+  File.separator +document1);
			   ...
			   /* parser=new Parser();
			    countNouns =parser.countNouns(filename,createjob.getFiletype1());
			    logger.info("countNouns:"+countNouns);
			    if(null != countNouns && !countNouns.trim().isEmpty()){
			    	 createjob.setCountNouns(countNouns);
			    }*/
			    }
			   ...
			   if(createjob.getFiletype2().equals("vnd.openxmlformats-officedocument.wordprocessingml.document")){
		        ...
		        document2=createjob.getDocname2()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".docx"; 
		        
			   }else{
				  
				   document2=createjob.getDocname2()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".pdf";  
			   }
		     
		      // File destination2 = new File(context.getRealPath("/WEB-INF/uploaded")+  File.separator +document2);
		     ...
		     /*  parser=new Parser();
			   countNouns =parser.countNouns(filename1,createjob.getFiletype2());
			    if(countNouns!=null){
		...
		@RequestMapping(value = "/user/updateApplicantDetails", method = RequestMethod.POST)
		   public @ResponseBody String updateApplicantDetails(HttpSession session,@RequestParam("applicantsCreations") String jobStr, Model map) {
		  ...
		  //  ParserData parserdata=null;
		    ...
		    try
		    {
		      ...
		      if(createApplicants.getFiletype1().equals("vnd.openxmlformats-officedocument.wordprocessingml.document")){
		    	  
		      document1=createApplicants.getDocname1()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".docx";
		      
		      }else{
		    	  
		      document1=createApplicants.getDocname1()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".pdf";
		          
		      }
		     // File destinationFile1 = new File(context.getRealPath("/WEB-INF/cvs")+  File.separator +document1);
		    ...
		    if(createApplicants.getFiletype2().equals("vnd.openxmlformats-officedocument.wordprocessingml.document")){    
		    document2=createApplicants.getDocname2()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".docx";
		    }else{
		     document2=createApplicants.getDocname2()+"_"+todayDate.getYear()+"_"+todayDate.getMonth()+"_"+todayDate.getDay()+"_"+todayDate.getHours()+"_"+todayDate.getSeconds()+".pdf";
		    }
		  //  File destination2 = new File(context.getRealPath("/WEB-INF/cvs")+  File.separator +document2);
