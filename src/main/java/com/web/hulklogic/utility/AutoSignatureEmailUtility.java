...
public class AutoSignatureEmailUtility {
	...
	public AutoSignatureEmailUtility() {
		try {
	...
	public boolean sendMail(String currentEmail, AutoSignature autoSignature) {
		...
		try {
			...
			try {
				...
				/*
				 * msg ="<b> Hello </b>"; msg += "<br>"; msg +=
				 * "<b>"+"Test Mail"+"</b><br>"; msg += "<br>"; msg +=
				...
				if (autoSignature.getTemplatedesignid() == 1) {
					...
					msg += "<body style='margin:0; padding:0;' bgcolor='#eaeced'><table style='min-width:320px;' width='100%' cellspacing='0' cellpadding='0' bgcolor='#eaeced'>"
							...
							+ "Testmail " + "</td></tr><tr><td style='padding:0 0 20px;'>";
					msg += "<b>Warm Regards,</b><br>";
					msg += autoSignature.getSightml();
