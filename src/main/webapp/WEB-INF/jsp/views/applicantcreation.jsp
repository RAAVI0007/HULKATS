				...
				<form id="taskregistration" name="taskregistration">
					...
					<div class="form-group">
						<div class="form-row">
							...
							<div class="col-md-6">
								<label for="address"><strong>City & State</strong></label> <select
...
user.location = array.join(', ');
   		...
   		if($('#lastjob').val()=='' || $('#lastjob').val().trim()==''){
   			$('#error').text('Last Job Title is required !');
   			$('#lastjob').attr('style', "border-radius: 5px; border:#FF0000 1px solid;");
   			return;	
   		}else{
   			user.lastjobtitle =$('#lastjob').val();		
   		}
