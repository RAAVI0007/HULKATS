		...
		<br>
				...
				<!--  <div class="form-group">
					<div class="input-group">
						...
						</span> <select class="form-control select2-single" id="joblist">
				...
				<div class="form-group">
					...
					<select id="joblist" class="form-control select2-single">
							<option>Select Job</option>
					</select>
				</div>
			</div>
	 ...
	 var doc2;
	  $('#joblist').on('change', function() {
		 ...
		 $.ajax({
			 ...
			 url:"${pageContext.servletContext.contextPath}/manager/getApplication",
    				...
    				complete : function(data) {
    					  ...
    					  if(data.responseJSON[0].attachement== null ){
    			    	       $("#tem1").css("display", "none");
    			    	    	 ...
    			    	    	 temp = data.responseJSON[0].attachement;
    			    	         $("#temdoc2").text(data.responseJSON[0].attachement.replace(/[\d_]+/g, ''));
    			    	         $("#tem1").css("display", "block");
    			    	        }
    			    	        ...
    			    	        if(data.responseJSON[0].attachement1 == null){
    			    	         $('#tem2').css('display','none');
    			    	        	...
    			    	        	$('#tem2').css('display','block');
    			    	        	temp1 = data.responseJSON[0].attachement1;
    			    	        	$("#temdoc1").text(data.responseJSON[0].attachement1.replace(/[\d_]+/g, ''));
