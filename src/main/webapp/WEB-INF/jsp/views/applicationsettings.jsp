	...
	<div class="container-fluid">
		...
		<div class="tab-nav">
			<ul id="industry-carousel" class="fetjob-lists">
				...
				<li class="wow fadeInLeft lst-li" data-wow-duration="0.8s"
		...
		<div id="documents">
			<div class="form-group">
				<div class="form-row">
					...
					<div class="col-md-3">
						<div id=apps1>
							<label><strong>Applicant Documents</strong></label> <br> <i
								class="fa fa-fw fa fa-file-text-o"></i> <a id="appdocs1"
								onclick="apporginals1()"></a> <br>
						</div>
						<div id=apps2>
						...
						<div id="documentstemp" style="display: none;">
							...
							<div id=tem1>
								...
								<i class="fa fa-fw fa fa-file-text-o"></i> <a id="temdoc2"
									onclick="temporg()"></a> <a id="cross" onclick='firstdocdel();'>&#x274C;</a>
							</div>
       ...
       var x = window.location.href;	
   		...
   		id=historyid;
   		 $.ajax({
             ...
             complete: function(data) {
		    	 ...
		    	 if(data.responseJSON.attachement4== null && data.responseJSON.attachement1 == null && data.responseJSON.attachement2 == null && data.responseJSON.attachement3 == null){
		    	 ...
		    	 if(data.responseJSON.attachement1== null ){
		    	       $("#tem55").css("display", "none");
		    	         ...
		    	         $("#temdoc55").text(data.responseJSON.attachement1.replace(/[\d_]+/g, ''));
		    	        }
		    	        if(data.responseJSON.attachement2 == null){
		    	        	...
		    	        	$("#temdoc66").text(data.responseJSON.attachement2.replace(/[\d_]+/g, ''));
		    	        ...
		    	        if(data.responseJSON.attachement3== null ){
				    		 ...
				    		 his3 = data.responseJSON.attachement3;
				    	         $("#temdoc3").text(data.responseJSON.attachement3.replace(/[\d_]+/g, ''));
				    	        ...
				    	        if(data.responseJSON.attachement4 == null){
				    	         $('#tem4').css('display','none');
				    	           ...
				    	           $("#temdoc4").text(data.responseJSON.attachement4.replace(/[\d_]+/g, ''));
        	 ...
        	 $('#commentstatus').val('');
      		 $.ajax({
                 ...
                 complete: function(data) {
                	 ...
                	 $('#commentstatus').val(data.responseJSON.statuscomment);
         ...
         $(document).ready(function(){
        	 ...
        	 $.ajax({
                 ...
                 data:{app_id:app_id},
                 complete: function(data) {
                   $('#title').html(": " +data.responseJSON.jobtitle);
                   $('#name').html(": " +data.responseJSON.name);
                   $('#mobile').html(": " +data.responseJSON.contactno);
		 			        ...
		 			        complete: function(data) {
		 			            ...
		 			            if(data.responseJSON.uploaddocument2 == null){
		 			            	$("#docs2").css('display','none');
		 			            	 ...
		 			            	 $('#jobdocs2').append(data.responseJSON.uploaddocument2.replace(/[\d_]+/g, ''));
		 			            }
		 			            if(data.responseJSON.otheruploads == null){
		 			            	$("#apps2").css('display','none');
		 			            }
		 			            else{
		 			            	 $('#appdocs2').append(data.responseJSON.otheruploads.replace(/[\d_]+/g, ''));
		 			            }
		 			           $("#jobdocs1").append(data.responseJSON.uploaddocument1.replace(/[\d_]+/g, ''));
		 	                  
		 	                  $('#appdocs1').append(data.responseJSON.uplaodcv.replace(/[\d_]+/g, ''));
                                  ...
                                  { "data": null,
                                		 "mRender" : function ( data, type, full ) {
                                			 ...
                                			 if(particulars == 'Email'){
                                				 return '<div id="controls"><a id="arrow"  onclick="emailhistory('
													+ historyid
													+ ')"><img src="<c:url value='/resources/images/Button-Next-icon.png' />" /></a></div>';
                                			 }else if(particulars == 'change status'){
                                				 return '<div id="controls"><a id="arrow"  onclick="statushistory('
													+ historyid
													+ ')"><img src="<c:url value='/resources/images/Button-Next-icon.png' />" /></a></div>';
                                			 }
                                			 else if(particulars == 'Comment'){
                                				 return '<div id="controls"><a id="arrow"  onclick="commenthistory('
													+ historyid
													+ ')"><img src="<c:url value='/resources/images/Button-Next-icon.png' />" /></a></div>';
                                			 }
                                			 else if(particulars == 'Source Update'){
                                				 return '<div id="controls"><a id="arrow"  onclick="sourcehistory('
													+ historyid
													+ ')"><img src="<c:url value='/resources/images/Button-Next-icon.png' />" /></a></div>';
                                			 }
                                			 else{
                                				 return '<div id="controls"><a id="arrow"><img class="disabled" src="<c:url value='/resources/images/Button-Next-icon.png' />" /></a></div>';
                                			 }
                                		 }
                                  }
                                     ],
 	 ...
 	 win.document.write('<iframe src="' + voterimage + '" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%;" allowfullscreen></iframe>');
 		...
 		function apporginals2(data){
 		  ...
 		  $('#actions').on('change', function() {
		 			        ...
		 			        complete: function(data) {
		 			            ...
		 			            if(data.responseJSON.uploaddocument2 == null){
		 			            	$("#doc2").css('display','none');
		 			            	 ...
		 			            	 $('#jobdoc2').append(data.responseJSON.uploaddocument2);
		 			            }
		 			            if(data.responseJSON.otheruploads == null){
		 			            	$("#app2").css('display','none');
		 			            }
		 			            else{
		 			            	 $('#appdoc2').append(data.responseJSON.otheruploads);
		 			            }
		 			           $("#jobdoc1").append(data.responseJSON.uploaddocument1);
		 	                  
		 	                  $('#appdoc1').append(data.responseJSON.uplaodcv);
		    ...
		    function statuschange(){ 
 			 ...
 			 $('#success').text('');
  			$('#error').text('');
        	if($( "#applicantionstatus option:selected" ).text()=='Select Status' || $( "#applicantionstatus option:selected" ).text().trim()=='Select Status'){
        	...
        	console.log(user);
        	var jsonfile={application:JSON.stringify(user)};
        	   $.ajax({
          		 type:"POST",
          		dataType: "json",
          		data:jsonfile,
 		...
 		function appcomment(){
 			...
 			$.ajax({
         		 type:"POST",
         		dataType: "json",
         		data:{app_id:app_id,addComment:appcomment},
 ...
 win.document.write('<iframe src="' + voterimage + '" frameborder="0" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%;" allowfullscreen></iframe>');
	...
	function history1(){
   	  $.ajax({
             ...
             dataType: "json",
             data:{historyid:id,attachment:his1},
             complete: function(data) {
            	 console.log(data);
                 var uploaddocument1 = "data:application/pdf;base64,";
	...
	function history2(){
	   	  $.ajax({
	             ...
	             dataType: "json",
	             data:{historyid:id,attachment:his2},
	             complete: function(data) {
	            	 console.log(data);
	                 var uploaddocument1 = "data:application/pdf;base64,";
	...
	function history3(){
	   	  $.ajax({
	             ...
	             dataType: "json",
	             data:{historyid:id,attachment:his3},
	             complete: function(data) {
	            	 console.log(data);
	                 var uploaddocument1 = "data:application/pdf;base64,";
	...
	function history4(){
	   	  $.ajax({
	             ...
	             dataType: "json",
	             data:{historyid:id,attachment:his4},
	             complete: function(data) {
	            	 console.log(data);
	                 var uploaddocument1 = "data:application/pdf;base64,";
	...
	function sourcechange(){
		user={};
			 $('#success').text('');
			$('#error').text('');
    	if($( "#applicantionsource option:selected" ).text()=='Select Source' || $( "#applicantionsource option:selected" ).text().trim()=='Select Source'){
