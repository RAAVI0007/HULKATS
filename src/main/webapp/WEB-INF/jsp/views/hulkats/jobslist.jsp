...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a
				href="${pageContext.servletContext.contextPath}/manager/joblist">Job</a>
			</li>
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="popupbody">
				...
				<label>Select Action</label> <select id="action"
					...
					<sec:authorize access="hasRole('ROLE_MANAGER')">
					<option value="1">Assign Job</option>
					</sec:authorize>
...
<script>
	...
	$(document).ready(function() {
						...
						$.ajax({
									type : "POST",
									url : "${pageContext.servletContext.contextPath}/manager/getAllJobs",
									dataType : "json",
															...
															columns : [
																{ "data": null,
																	...
																	},
																	{
																		...
																		"render" : function(
																				data) {
																			return '<a id="arrow"  onclick="popupmodal('
																					+ data
		...
		var recuiteremail = $('#recruiters').val();
			$.ajax({
						...
						complete : function(data) {
							...
							else if (data.responseText == "Job is assign already") {
								$('#error1')
										.text("Job is assign already");
