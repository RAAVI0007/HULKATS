	...
	<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light"
		...
		<sec:authorize access="hasRole('ROLE_MANAGER')">
			<a class="navbar-brand"
				...
				<img id="logomanager" style="width: 170px;" />
			</a>
		</sec:authorize>
		<sec:authorize access="hasRole('ROLE_RECRUITER')">
			<a class="navbar-brand"
				href="${pageContext.servletContext.contextPath}/recruiter/recruiterdashboard"><img
				style="width: 170px;" id="logorecruiter" /></a>
		</sec:authorize>
		<sec:authorize access="hasRole('ROLE_BASICMANAGER')">
			<a class="navbar-brand"
				href="${pageContext.servletContext.contextPath}/basicmanager/dashboard"><img
				style="width: 170px;" id="logorecruiter" /></a>
		</sec:authorize>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				...
				<sec:authorize access="hasRole('ROLE_RECRUITER')">
					<li class="nav-item" data-toggle="tooltip" data-placement="right"
						title="Dashboard"><a class="nav-link"
						href="${pageContext.servletContext.contextPath}/recruiter/recruiterdashboard">
							<i class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text"><b>Dashboard</b></span>
					</a></li>
				</sec:authorize>
				...
				<sec:authorize access="hasRole('ROLE_BASICMANAGER')">
					<li class="nav-item" data-toggle="tooltip" data-placement="right"
						title="Dashboard"><a class="nav-link"
						href="${pageContext.servletContext.contextPath}/basicmanager/dashboard">
							<i class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text"><b>Dashboard</b></span>
					</a></li>
				</sec:authorize>
				...
				<sec:authorize access="hasRole('ROLE_RECRUITER')">
					<li class="nav-item" data-toggle="tooltip" data-placement="right"
						...
						href="${pageContext.servletContext.contextPath}/recruiter/teams">
							<i class="fa fa-fw fa fa-user"></i> <span class="nav-link-text"><b>Team</b></span>
					</a></li>
				</sec:authorize>
				...
				<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_BASICMANAGER')">
					<li class="nav-item" data-toggle="tooltip" data-placement="right"
						...
						<ul class="sidenav-second-level collapse" id="collapseComponents2">
							<li><a class='ref99'
								href="${pageContext.servletContext.contextPath}/user/jobcreation"><b>Add
										New</b></a></li>
							<li><a
								href="${pageContext.servletContext.contextPath}/manager/joblist"><b>View
										Jobs</b></a></li>
						</ul></li>
				</sec:authorize>
				<sec:authorize access="hasRole('ROLE_RECRUITER')">
						...
						<ul class="sidenav-second-level collapse" id="collapseComponents2">
							<li><a
								href="${pageContext.servletContext.contextPath}/user/jobcreation"><b>Add
										New</b></a></li>
							<li><a
								href="${pageContext.servletContext.contextPath}/recruiter/jobview"><b>View
										Jobs</b></a></li>
						</ul></li>
				</sec:authorize>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Refferal"><a class="nav-link"
					href="https://hulkats.com/employeeapp" target="_blank"> <i
						class="fa fa-fw fa fa-external-link-square"></i> <span
						class="nav-link-text"><b>Referral</b></span>
				</a></li>
			</ul>
			...
			<ul class="navbar-nav ml-auto">
				...
				<a
					...
					href="#" data-toggle="dropdown" data-placement="right"
					aria-haspopup="true" aria-expanded="false"> <i
						class="fa fa-fw fa-envelope"></i> <span class="d-lg-none">Messages
							<span class="badge badge-pill badge-primary" id="msgcount"></span>
					</span> <span class="indicator text-primary d-none d-lg-block"> <i><span
								class='badge badge-info float-left' id="msgcount1"></span></i>
					</span>
				</a>
					<div class="dropdown-menu dropdown-menu-right"
						...
						<div>
							...
							<a class="dropdown-item small"
								href="${pageContext.servletContext.contextPath}/user/allmessages"
								target='_blank'>View all messages</a>
								
						</div>
					</div></li></sec:authorize>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle mr-sm-1" id="alertsDropdown"
					href="#" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fa fa-fw fa-bell"></i> <span
						class="d-lg-none">Alerts <span
							class="badge badge-info badge-warning" id="alertcount"></span>
					</span> <span class="indicator text-warning d-none d-sm-block"> <i><span
								class="badge badge-info float-left" id="alertcount1"></span></i>
					</span>
				</a>
					<div class="dropdown-menu dropdown-menu-right"
						...
						<div>
							<hr>
							<a class="dropdown-item small"
								href="${pageContext.servletContext.contextPath}/user/alerts"
								target='_blank'>View all alerts</a>
						</div>
					</div></li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu dropdown-menu-right"
						...
						<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_BASICMANAGER')">
							<a class="dropdown-item"
								href="${pageContext.servletContext.contextPath}/manager/settings">
								<i class="fa fa-gear fa-fw"></i>Settings
							</a>
						</sec:authorize>
						<sec:authorize access="hasRole('ROLE_RECRUITER')">
							<a class="dropdown-item"
								href="${pageContext.servletContext.contextPath}/recruiter/rssettings">
								<i class="fa fa-gear fa-fw"></i>Settings
							</a>
						</sec:authorize>
					</div></li>
