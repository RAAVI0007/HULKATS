					...
					<div class="card p-4">
						...
						<div class="card-body py-5">
							<div class="form-group">
								<label>New Password </label> <input name="password"
							...
							<div class="form-group">
								<label>Confirm password</label> <input type="password"
									...
									class="form-control" placeholder="Re-enter New Password" /> <span
									id='message'></span>
							</div>
							<div class="card-footer">
								<div class="row">
									<div class="col-6">
										<button id="submit" onclick="getotp()"
	...
	<script>
		...
		function getotp() {
			...
			$
					.ajax({
						type : "POST",
						url : "${pageContext.servletContext.contextPath}/login/createpwd",
						data : {
							"id" : tech,
							"pwd" : password
						},
						...
						complete : function(result) {
							...
							if (result.responseText == "success") {
								...
								$('#error').text("Password creation failed!");
								$('#success').text("");
